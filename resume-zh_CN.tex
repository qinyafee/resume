...
8年智驾开发/管理，量产经验丰富，自驱力强；熟悉感知、数据合成、自动标注、地图定位开发业务
...
\begin{itemize}[parsep=0.5ex]
  ...
  \item 传统CV/slam：鱼眼内参模型、图像/特征点矫正、多视图几何、预积分；图优化、EKF/UKF、粒子滤波；数据关联JPDA、HM匹配、车道线匹配；开源框架：ORB\_SLAM/VINS-Mono/MSCKF/OpenVins；工具：ROS、PCL、OpenCV、g2o、Ceres Solver
...
\begin{onehalfspacing}
  ...
  负责数据合成业务
  \begin{itemize}
    \item 主导感知训练数据合成、端到端闭环仿真业务
    \item 带领团队开发预处理、3dgs场景重建、3d资产生成、资产插入、场景可控生成模型、闭环仿真框架
    \item 可重建行人等柔性物体；可生成360°资产，如海外TSI、锥桶、水马、异型车辆、异型障碍物等
    \item 目前已经上线，支持修改传感器内外参、动/静态障碍物编辑、在2d视频流/3d场景中插入物体、红绿灯控制，支持NVS渲染及全链路闭环仿真
    \item 交付纯视觉点云，支持无lidar数据标注
    \item 场景可控生成：可生成多视角图片/短视频，支持天气、光照、障碍物等控制
  \end{itemize}

  负责泊车感知建图的开发
  \begin{itemize}
    \item 主导IPM拼接、停车位/freespace/OD检测、后处理、记忆建图等开发任务
