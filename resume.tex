...
8 years on ADAS with mass production knowledge, expert in localization, mapping, Hdmap, calibration
...
\begin{itemize}
  \item Devlop MOTOR\&MCU System, E-Pump/E-fan, Promote to solve issues of NVH, EMC, etc.
  \item Analyze and fulfill requirements of other modules, like ESP, Security, TBOX and Slope Parking
  \item self driving algorithm demo in office zone
\end{itemize}
...
\begin{itemize}[parsep=0.5ex]
  \item Implement dynamic initilization for a multi-vio system(VR device) {2021/2--2022/5}
  \item CN117310756B Multi-sensor fusion positioning method and system, machine-readable storage medium 2023.12.29
  \item CN117249839A Lane map generation method, device, equipment and storage medium 2023.12.19
\end{itemize}
